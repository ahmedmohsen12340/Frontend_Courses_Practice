...
// class Player{
// vipp : string = "";
// constructor(public user:string,public type : string,public level:(string|number),public vip?: boolean){}
// details(){
// if(this.vip === true)
//     this.vipp ="VIP";

// return `${this.vipp} ${this.user}, Type is ${this.type} level is ${this.level}`
// }
// }
// // Do Not Edit The Code Below
